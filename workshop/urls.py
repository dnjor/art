...
urlpatterns = [
    ...
    path("<int:workshop_id>/registrations/", views.workshop_registrations, name="workshop_registrations"),
    path("<int:workshop_id>/registrations/send_review/", views.send_link_review, name="send_link_review"),
    path("registrations/<int:registration_id>/<str:status>/", views.update_registration_status, name="update_registration_status"),
]
